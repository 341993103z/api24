...
smtp_user='341993103@qq.com'
smtp_ps='nvgvhinjszswcbdc'
sender=smtp_user
receiver='341993103@qq.com'
subject='接口测试报告'
...
parser.add_option("--rerun-fails",dest="rerun_fails",action="store_true",help="重跑失败用例")
